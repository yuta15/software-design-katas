...
class Usecase:
    def __init__(
        self, output_set_factory: OutputSetFactory, new_entity_factory: NewEntityFactory
    ):
    ...
    def execute(self, input: Input) -> None:
        ...
        outputter = self._output_set_factory.create(
            format_type=format_type, data=entity
        )
        outputter.output()
